...
let list = (filepath, destination_directory) => {
  const students = validate(filepath)
  ...
  if (students) {
    edlfiles.genStudentList(students, destination_directory + '/StudentList.csv')
  }
}
...
cli
  .command('list <filepath> [destination_directory]')
